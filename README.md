...
![Schéma d’architecture complet](attachments/smarthome_architecture_final.png)
...
→ [Télécharger le schéma haute qualité](attachments/smarthome_architecture_final.png)
[Si vous préférer les Schematics...](attachments/Schematic.pdf)

(Le fichier png ci-dessus est entièrement vectoriel, modifiable et avec icônes réalistes)
Le schematic est aussi attaché en bas, dans la section de téléchargement.

## 3. Diagrammes de cas d’usage (Use Case)

### Use Case 1 – Alarme déclenchée par ouverture de fenêtre (système armé)

![Use Case Alarme Fenêtre](attachments/usecase_alarme_fenetre.png)

### Use Case 2 – Déverrouillage porte avec le bon code

![Use Case Déverrouillage](attachments/usecase_deverrouillage_porte.png)
...
2. Objet proche (< 40 cm) → envoie statut via BLE à ESP32 #2
...
| Fichier                                    | Description                                 |
|--------------------------------------------|---------------------------------------------|
| [smarthome_architecture_final.png](attachments/smarthome_architecture_final.png)       | Schéma complet avec icônes réalistes        |
...
- [x] Caméra déclenchée par mouvement
- [ ] Mode vacances / mode nuit

---
**Projet terminé et 100 % fonctionnel – Décembre 2025**

Tout est open-source, modifiable et prêt à être déployé. Le schematic est inclus!
